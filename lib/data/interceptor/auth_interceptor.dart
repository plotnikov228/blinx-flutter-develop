...
import 'package:blinx/data/interceptor/meta_interceptor.dart';
import 'package:blinx/data/model/auth/auth_tokens.dart';
import 'package:blinx/data/services/http_client/dio_http_client.dart';
import 'package:blinx/data/services/http_client/http_client.dart';
import 'package:blinx/data/services/response_error.dart';
import 'package:blinx/data/services/response_objects/tokens_response.dart';
...
class AuthInterceptor extends InterceptorsWrapper {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    } if (options.headers['session_id'] == null) {
      options.headers['session_id'] = getDeviceIdentifier();
    }
