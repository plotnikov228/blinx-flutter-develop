...
class _CategoriesRemoteDataSource implements CategoriesRemoteDataSource {
  ...
  Future<List<Category>> getAllCategories() async {
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/categories?renditions=original&type=category',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  @override
  Future<List<Category>> likeCategories(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ReplaceCategoriesResponse> replaceLikedCategories(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ReplaceCategoriesResponse>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              '/categories/replaceLikes',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = ReplaceCategoriesResponse.fromJson(_result.data!);
    return value;
  }
