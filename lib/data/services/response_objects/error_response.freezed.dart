...
// No map key exists, so created with values
  ErrorName get message => throw _privateConstructorUsedError;
...
class _$_ErrorResponse implements _ErrorResponse {
  const _$_ErrorResponse({this.message = ErrorName.unknown});
...
abstract class _ErrorResponse implements ErrorResponse {
  const factory _ErrorResponse({final ErrorName message}) = _$_ErrorResponse;

  factory _ErrorResponse.fromJson(Map<String, dynamic> json) =
      _$_ErrorResponse.fromJson;

  @override //if no map key exists then just create this factory with the APIError values
//and remove APIError,
//required APIError error,
// No map key exists, so created with values
  ErrorName get message;
  @override
  @JsonKey(ignore: true)
  _$$_ErrorResponseCopyWith<_$_ErrorResponse> get copyWith =>
      throw _privateConstructorUsedError;
