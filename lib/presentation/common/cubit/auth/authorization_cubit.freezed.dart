...
class _$_AuthorizationState extends _AuthorizationState {
  _$_AuthorizationState({this.isAuthenticated = false}) : super._();
  ...
  @override
  String toString() {
    return 'AuthorizationState(isAuthenticated: $isAuthenticated)';
  }
...
abstract class _AuthorizationState extends AuthorizationState {
  factory _AuthorizationState({final bool isAuthenticated}) =
