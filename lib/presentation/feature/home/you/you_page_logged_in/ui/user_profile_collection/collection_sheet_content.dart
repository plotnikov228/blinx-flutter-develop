...
import 'package:blinx/presentation/feature/home/you/you_page_logged_in/ui/user_profile_collection/rename_collection_dialog_content.dart';
...
class CollectionSheetContent extends StatelessWidget {
  ...
  void _onTapAddCollectionButton(BuildContext context, int idCollection) =>
      showDialog(
        context: context,
        builder: (BuildContext context) =>
            addCollectionDialog(context, idCollection),
      );

  Widget addCollectionDialog(BuildContext context, int idCollection) {
    return RenameCollectionDialogContent(
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        BottomSheetListTile(
          text: i18n.collection.rename,
          svgPath: Assets.icons.renameIcon.path,
          onTap: () {
            Navigator.pop(context);
            _onTapAddCollectionButton(context, idCollection);
          },
        ),
      ],
    );
