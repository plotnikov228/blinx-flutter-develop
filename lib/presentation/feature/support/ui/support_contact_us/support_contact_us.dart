...
class SupportContactUsTabPage extends StatelessWidget {
  const SupportContactUsTabPage({super.key});
      ...
      child: AppSingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            AppSettingsTitle(text: i18n.generalInquires),
            AppText.body300Font13(
              i18n.forGeneralEnquiries,
            ),
            ...
            AppSettingsTitle(text: i18n.advertising),
            AppText.body300Font13(
              i18n.forInformationAboutAdvertising,
            ),
            const SizedBox(height: 18),
            SizedBox(
              width: 168,
