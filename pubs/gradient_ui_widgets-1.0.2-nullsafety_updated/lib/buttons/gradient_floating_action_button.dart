...
class GradientFloatingActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (this.foregroundColor == null &&
      ...
      final bool accentIsDark = theme.floatingActionButtonTheme.foregroundColor == Brightness.dark;
      final Color defaultAccentIconThemeColor =
          accentIsDark ? Colors.white : Colors.black;
      if (theme.floatingActionButtonTheme.foregroundColor != defaultAccentIconThemeColor) {
        debugPrint('Warning: '
